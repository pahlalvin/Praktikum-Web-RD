			...
			<div class="item form-group">
				...
				<div class="col-md-6 col-sm-6">
					<select name="Program_Studi" class="form-control" required>
						...
						<option value="Teknik Geologi" <?php if($data['Program_Studi'] == 'Teknik Geologi'){ echo 'selected'; } ?>>Teknik Geologi</option>
						<option value="Artitektur" <?php if($data['Program_Studi'] == 'Artitektur'){ echo 'selected'; } ?>>Artitektur</option>
						<option value="DKV" <?php if($data['Program_Studi'] == 'DKV'){ echo 'selected'; } ?>>DKV</option>
						<option value="Telekomunikasi" <?php if($data['Program_Studi'] == 'Telekomunikasi'){ echo 'selected'; } ?>>Telekomunikasi</option>
					</select>
				</div>
			</div>
			<div class="item form-group">
