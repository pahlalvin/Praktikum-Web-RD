...
<html lang="en">
  <head>
	...
	<link rel="icon" href="assets/images/itera.png" type="image/ico" />
          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="assets/images/alvin.jpg" alt="..." class="img-circle profile_img">
              </div>
              <div class="profile_info">
                <span>Welcome,</span>
                <h2>Alvin Pasmah 118130024</h2>
              </div>
            </div>
            <!-- /menu profile quick info -->
              ...
              <ul class=" navbar-right">
                <li class="nav-item dropdown open" >
                  <a href="#" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                    <img src="assets/images/alvin.jpg" alt="">Alvin Pasmah
                  </a>
      ...
      switch ($queries['page']) {
        ...
        <footer>
          <div class="pull-right">
            Copyright @ 2021 PemWeb RD : Alvin Pasmah
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
